...
if __name__ == '__main__':
    ...
    parser.add_option('--parity', dest='parity', choices=('0','1','2'), help='Parity (flip) of image')
    ...
    img_name = opt.upload_xy.split("/")[-1]
    ...
    if opt.upload or opt.upload_url or opt.upload_xy:
        ...
        if opt.upload_xy:
            with fits.open(opt.upload_xy) as hdul:
                T = hdul[1].data
